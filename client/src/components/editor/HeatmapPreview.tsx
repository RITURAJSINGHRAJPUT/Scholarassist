...
export default function HeatmapPreview({ aiResult, isAnalyzing, onClose }: HeatmapPreviewProps) {
    if (!aiResult) {
        return (
    ...
    return (
        <div className="w-full h-full bg-slate-50 flex flex-col pt-[5rem] overflow-hidden border-l border-slate-200 relative">
            ...
            <div className="bg-white px-6 py-3 border-t border-slate-200 flex items-center justify-center gap-6 text-[11px] font-bold uppercase tracking-widest flex-shrink-0 z-10">
                <div className="flex items-center gap-2 text-emerald-700">
                    <span className="w-3 h-3 rounded bg-emerald-100 border border-emerald-300"></span> 0 - 35% Human
                </div>
                <div className="flex items-center gap-2 text-amber-700">
                    <span className="w-3 h-3 rounded bg-amber-100 border border-amber-300"></span> 36 - 65% Mixed
                </div>
                <div className="flex items-center gap-2 text-red-700">
                    <span className="w-3 h-3 rounded bg-red-100 border border-red-300"></span> 66 - 100% AI
                </div>
            </div>
